# Comparing `tmp/blackarrow-1.1.5.tar.gz` & `tmp/blackarrow-1.1.6.tar.gz`
...
+gzip compressed data, was "blackarrow-1.1.6.tar", max compression
```

## Comparing `blackarrow-1.1.5.tar` & `blackarrow-1.1.6.tar`
...
+-rw-r--r--   0        0        0     1076 2023-05-24 04:30:00.135084 blackarrow-1.1.6/LICENSE.txt
+-rw-r--r--   0        0        0     3222 2023-05-24 04:30:00.135084 blackarrow-1.1.6/README.md
+-rw-r--r--   0        0        0     2843 2023-05-24 04:30:00.135084 blackarrow-1.1.6/blackarrow/__init__.py
+-rwxr-xr-x   0        0        0     8225 2023-06-09 15:38:56.212830 blackarrow-1.1.6/blackarrow/blackarrow.py
+-rw-r--r--   0        0        0        0 2023-05-24 04:30:00.135084 blackarrow-1.1.6/blackarrow/test/__init__.py
+-rw-r--r--   0        0        0     1114 2023-05-24 04:30:00.135084 blackarrow-1.1.6/blackarrow/test/test_indexing.py
+-rw-r--r--   0        0        0     1069 2023-06-09 15:41:25.542832 blackarrow-1.1.6/pyproject.toml
+-rw-r--r--   0        0        0      104 2023-05-24 04:30:00.135084 blackarrow-1.1.6/sample/tester.txt
+-rw-r--r--   0        0        0      104 2023-05-24 04:30:00.135084 blackarrow-1.1.6/sample/tester2.txt
+-rw-r--r--   0        0        0     4141 1970-01-01 00:00:00.000000 blackarrow-1.1.6/setup.py
+-rw-r--r--   0        0        0     4415 1970-01-01 00:00:00.000000 blackarrow-1.1.6/PKG-INFO
```

### Comparing `blackarrow-1.1.5/LICENSE.txt` & `blackarrow-1.1.6/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.5/README.md` & `blackarrow-1.1.6/README.md`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.5/blackarrow/__init__.py` & `blackarrow-1.1.6/blackarrow/__init__.py`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.5/blackarrow/blackarrow.py` & `blackarrow-1.1.6/blackarrow/blackarrow.py`
...
### Comparing `blackarrow-1.1.5/blackarrow/test/test_indexing.py` & `blackarrow-1.1.6/blackarrow/test/test_indexing.py`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.5/pyproject.toml` & `blackarrow-1.1.6/pyproject.toml`
...
### Comparing `blackarrow-1.1.5/setup.py` & `blackarrow-1.1.6/setup.py`
...
### Comparing `blackarrow-1.1.5/PKG-INFO` & `blackarrow-1.1.6/PKG-INFO`
