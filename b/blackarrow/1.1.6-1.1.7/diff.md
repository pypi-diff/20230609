# Comparing `tmp/blackarrow-1.1.6.tar.gz` & `tmp/blackarrow-1.1.7.tar.gz`
...
## Comparing `blackarrow-1.1.6.tar` & `blackarrow-1.1.7.tar`
...
### Comparing `blackarrow-1.1.6/LICENSE.txt` & `blackarrow-1.1.7/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.6/README.md` & `blackarrow-1.1.7/README.md`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.6/blackarrow/__init__.py` & `blackarrow-1.1.7/blackarrow/__init__.py`
...
### Comparing `blackarrow-1.1.6/blackarrow/blackarrow.py` & `blackarrow-1.1.7/blackarrow/blackarrow.py`
...
### Comparing `blackarrow-1.1.6/blackarrow/test/test_indexing.py` & `blackarrow-1.1.7/blackarrow/test/test_indexing.py`

 * *Files identical despite different names*

### Comparing `blackarrow-1.1.6/pyproject.toml` & `blackarrow-1.1.7/pyproject.toml`
...
### Comparing `blackarrow-1.1.6/setup.py` & `blackarrow-1.1.7/setup.py`
...
### Comparing `blackarrow-1.1.6/PKG-INFO` & `blackarrow-1.1.7/PKG-INFO`
