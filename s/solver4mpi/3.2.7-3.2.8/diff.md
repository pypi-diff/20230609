# Comparing `tmp/solver4mpi-3.2.7.tar.gz` & `tmp/solver4mpi-3.2.8.tar.gz`
...
## Comparing `solver4mpi-3.2.7.tar` & `solver4mpi-3.2.8.tar`
...
### Comparing `solver4mpi-3.2.7/setup.py` & `solver4mpi-3.2.8/setup.py`
...
### Comparing `solver4mpi-3.2.7/solver4mpi/minimizer_multiprocess.py` & `solver4mpi-3.2.8/solver4mpi/minimizer_multiprocess.py`
...
### Comparing `solver4mpi-3.2.7/solver4mpi/test.py` & `solver4mpi-3.2.8/solver4mpi/test.py`

 * *Files identical despite different names*

### Comparing `solver4mpi-3.2.7/solver4mpi/test_mpi.py` & `solver4mpi-3.2.8/solver4mpi/test_mpi.py`
