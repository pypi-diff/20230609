# Comparing `tmp/hasiicommon-0.2.2.tar.gz` & `tmp/hasiicommon-0.3.0.tar.gz`
...
### Comparing `hasiicommon-0.2.2/hasiicommon.egg-info/SOURCES.txt` & `hasiicommon-0.3.0/hasiicommon.egg-info/SOURCES.txt`
