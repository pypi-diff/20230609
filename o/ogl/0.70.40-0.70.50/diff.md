# Comparing `tmp/ogl-0.70.40.tar.gz` & `tmp/ogl-0.70.50.tar.gz`
...
### Comparing `ogl-0.70.40/ogl/ui/DefaultValuesPreferencesPage.py` & `ogl-0.70.50/ogl/ui/DefaultValuesPreferencesPage.py`
