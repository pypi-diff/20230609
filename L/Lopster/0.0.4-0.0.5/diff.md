# Comparing `tmp/Lopster-0.0.4.tar.gz` & `tmp/Lopster-0.0.5.tar.gz`
...
## Comparing `Lopster-0.0.4.tar` & `Lopster-0.0.5.tar`
...
### Comparing `Lopster-0.0.4/Lopster/Lopster.py` & `Lopster-0.0.5/Lopster/Lopster.py`
