# Comparing `tmp/databind-4.3.1.tar.gz` & `tmp/databind-4.3.2.tar.gz`
...
## Comparing `databind-4.3.1.tar` & `databind-4.3.2.tar`
...
### Comparing `databind-4.3.1/README.md` & `databind-4.3.2/README.md`

 * *Files identical despite different names*

### Comparing `databind-4.3.1/pyproject.toml` & `databind-4.3.2/pyproject.toml`
...
### Comparing `databind-4.3.1/setup.py` & `databind-4.3.2/setup.py`
...
### Comparing `databind-4.3.1/PKG-INFO` & `databind-4.3.2/PKG-INFO`
