# Comparing `tmp/jag-panzer-0.0.3.tar.gz` & `tmp/jag-panzer-0.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jag-panzer-0.0.3.tar", last modified: Fri Jun  9 00:34:45 2023, max compression
+gzip compressed data, was "jag-panzer-0.0.5.tar", last modified: Fri Jun  9 01:30:24 2023, max compression
```

## Comparing `jag-panzer-0.0.3.tar` & `jag-panzer-0.0.5.tar`

### file list

```diff
@@ -1,26 +1,103 @@
-drwxrwxrwx   0        0        0        0 2023-06-09 00:34:45.538864 jag-panzer-0.0.3/
--rw-rw-rw-   0        0        0       68 2023-06-09 00:05:07.000000 jag-panzer-0.0.3/LICENSE
--rw-rw-rw-   0        0        0      560 2023-06-09 00:34:45.538864 jag-panzer-0.0.3/PKG-INFO
--rw-rw-rw-   0        0        0       26 2023-06-09 00:32:58.000000 jag-panzer-0.0.3/README.md
--rw-rw-rw-   0        0        0      108 2023-06-09 00:12:29.000000 jag-panzer-0.0.3/pyproject.toml
--rw-rw-rw-   0        0        0      671 2023-06-09 00:34:45.543871 jag-panzer-0.0.3/setup.cfg
-drwxrwxrwx   0        0        0        0 2023-06-09 00:34:45.480899 jag-panzer-0.0.3/src/
-drwxrwxrwx   0        0        0        0 2023-06-09 00:34:45.489892 jag-panzer-0.0.3/src/jag/
--rw-rw-rw-   0        0        0        0 2023-06-09 00:13:59.000000 jag-panzer-0.0.3/src/jag/__init__.py
-drwxrwxrwx   0        0        0        0 2023-06-09 00:34:45.500886 jag-panzer-0.0.3/src/jag/cgi/
--rw-rw-rw-   0        0        0        0 2023-06-09 00:00:24.000000 jag-panzer-0.0.3/src/jag/cgi/__init__.py
--rw-rw-rw-   0        0        0     5087 2023-06-03 17:16:43.000000 jag-panzer-0.0.3/src/jag/cgi/burn_power.py
--rw-rw-rw-   0        0        0      451 2023-06-03 17:16:43.000000 jag-panzer-0.0.3/src/jag/cgi/hitman.py
--rw-rw-rw-   0        0        0     6691 2023-06-03 17:16:43.000000 jag-panzer-0.0.3/src/jag/cgi/jag.py
-drwxrwxrwx   0        0        0        0 2023-06-09 00:34:45.513878 jag-panzer-0.0.3/src/jag/panzer/
--rw-rw-rw-   0        0        0       19 2023-06-03 17:16:43.000000 jag-panzer-0.0.3/src/jag/panzer/__init__.py
--rw-rw-rw-   0        0        0    16948 2023-06-08 23:41:16.000000 jag-panzer-0.0.3/src/jag/panzer/base_room.py
--rw-rw-rw-   0        0        0     2539 2023-06-08 21:42:17.000000 jag-panzer-0.0.3/src/jag/panzer/dir_list.py
--rw-rw-rw-   0        0        0      369 2023-06-07 05:17:03.000000 jag-panzer-0.0.3/src/jag/panzer/jag_util.py
--rw-rw-rw-   0        0        0     1938 2023-06-03 17:16:43.000000 jag-panzer-0.0.3/src/jag/panzer/response_codes.py
--rw-rw-rw-   0        0        0     7363 2023-06-08 23:38:46.000000 jag-panzer-0.0.3/src/jag/panzer/server.py
-drwxrwxrwx   0        0        0        0 2023-06-09 00:34:45.536865 jag-panzer-0.0.3/src/jag_panzer.egg-info/
--rw-rw-rw-   0        0        0      560 2023-06-09 00:34:45.000000 jag-panzer-0.0.3/src/jag_panzer.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      472 2023-06-09 00:34:45.000000 jag-panzer-0.0.3/src/jag_panzer.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-06-09 00:34:45.000000 jag-panzer-0.0.3/src/jag_panzer.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0        4 2023-06-09 00:34:45.000000 jag-panzer-0.0.3/src/jag_panzer.egg-info/top_level.txt
...
### Comparing `jag-panzer-0.0.3/PKG-INFO` & `jag-panzer-0.0.5/PKG-INFO`
...
### Comparing `jag-panzer-0.0.3/setup.cfg` & `jag-panzer-0.0.5/setup.cfg`
...
### Comparing `jag-panzer-0.0.3/src/jag/cgi/burn_power.py` & `jag-panzer-0.0.5/src/jag_panzer/cgi/burn_power.py`

 * *Files identical despite different names*

### Comparing `jag-panzer-0.0.3/src/jag/cgi/jag.py` & `jag-panzer-0.0.5/src/jag_panzer/cgi/jag.py`

 * *Files identical despite different names*

### Comparing `jag-panzer-0.0.3/src/jag/panzer/base_room.py` & `jag-panzer-0.0.5/src/jag_panzer/base_room.py`

 * *Files identical despite different names*

### Comparing `jag-panzer-0.0.3/src/jag/panzer/dir_list.py` & `jag-panzer-0.0.5/src/jag_panzer/dir_list.py`

 * *Files identical despite different names*

### Comparing `jag-panzer-0.0.3/src/jag/panzer/response_codes.py` & `jag-panzer-0.0.5/src/jag_panzer/response_codes.py`

 * *Files identical despite different names*

### Comparing `jag-panzer-0.0.3/src/jag/panzer/server.py` & `jag-panzer-0.0.5/src/jag_panzer/server.py`

 * *Files identical despite different names*

### Comparing `jag-panzer-0.0.3/src/jag_panzer.egg-info/PKG-INFO` & `jag-panzer-0.0.5/src/jag_panzer.egg-info/PKG-INFO`
